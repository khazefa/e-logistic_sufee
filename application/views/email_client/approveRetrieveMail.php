                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                                <td align="left" valign="middle" width="100%" style="font-size: 14px; color: #808080; line-height: 22px; font-weight: 400;">
                                                                                                                                    <table width="100%">
                                                                                                                                        ...
                                                                                                                                        <tr><td>Service Type</td><td>: <?php echo $service;?> - <?php echo $type;?></td></tr>
                                                                                                                                ...
                                                                                                                                <td>
                                                                                                                                    <table width="100%" border="1" cellpadding="0" cellspacing="0">
                                                                                                                                        ...
                                                                                                                                        <tbody>
                                                                                                                                            <?php
                                                                                                                                                foreach($result as $r){
                                                                                                                                                    $barcode_id = strip_tags($r['barcode_id']);
                                                                                                                                                    $claim_id = strip_tags($r['claim_id']);
                                                                                                                                                    $dmc_date = date("d/m/Y", strtotime($r['sub_DateEntry']));
                                                                                                                                                    $doc_type = strip_tags($r['doc_type']);
                                                                                                                                                    $box_id = strip_tags($r['box_id']);
                                                                                                                                                    echo "<tr>";
                                                                                                                                                    echo "<td>$barcode_id</td>";
                                                                                                                                                    echo "<td>$claim_id</td>";
                                                                                                                                                    echo "<td>$dmc_date</td>";
                                                                                                                                                    echo "<td>$doc_type</td>";
                                                                                                                                                    echo "<td>$box_id</td>";
