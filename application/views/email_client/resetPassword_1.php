...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div>
            ...
            <tbody>
                <tr>
                <th style="border-top:solid 5px #810000;font-weight:normal;text-align:center;background:#ffffff;border-bottom:solid 1px #e3e5e1">
                                                ...
                                                <cite style="text-align:center;display:block;font-style:normal">
                                                    ...
                                                    <dl style="list-style-type:none;padding:0;overflow:hidden;margin:0">
                                                        <dt style="font-size:15px;display:inline-block;width:100%;margin:0;padding:0 0 12px 0;vertical-align:top;padding-bottom:0!important">
                                                            <!-- <a href="<?php echo base_url(); ?>" title="DN-UG Storage Management" style="display:inline-block" target="_blank">DN-UG Storage Management</a> -->
                                                            <img src="http://media.search.lt/GetFile.php?OID=269798&filetype=4" width="150" alt="Diebold Nixdorf" border="0"  />
                                                        </dt>
