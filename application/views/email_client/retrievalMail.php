                                                                                                                ...
                                                                                                                <table width="280" border="0" cellpadding="0" cellspacing="0" align="right">	
                                                                                                                        <tr>
                                                                                                                                <td height="60" valign="middle" width="100%" align="right">
                                                                                                                                    <span style="color: #333333;"><?php echo $pageTitle; ?></span>
                                                                                                                                </td>
                                                                                                                        </tr>
                                                                                                                </table>
                                                                                                                <!-- /view Online --> 
                                                                                                                ...
                                                                                                                <table width="600" border="0" cellpadding="0" cellspacing="0" align="center">
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                                <td align="left" valign="middle" width="100%" style="font-size: 14px; color: #808080; line-height: 22px; font-weight: 400;">
                                                                                                                                    <table width="100%">
                                                                                                                                        <tr><td width="20%">Service Type :</td><td>Regular - Folder</td></tr>
                                                                                                                                        <tr><td>Request By :</td><td>User 1</td></tr>
                                                                                                                                        <tr><td>Approved By :</td><td>SUser 1</td></tr>
                                                                                                                                        <tr><td>Approval Date :</td><td>01/01/2018 14:30:00</td></tr>
                                                                                                                                        <tr><td>Due Date :</td><td>02/01/2018 14:00:00</td></tr>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                                <td>
                                                                                                                                    <table width="100%" border="1" cellpadding="0" cellspacing="0">
                                                                                                                                        ...
                                                                                                                                        <tbody>
                                                                                                                                        <tr>
                                                                                                                                            <td>$170108171025392</td>
                                                                                                                                            <td>18/02/2018</td>
                                                                                                                                            <td>55011849-01</td>
                                                                                                                                            <td>CLAIM EB REIMBURSEMENT</td>
                                                                                                                                            <td>2017090001</td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td>$170108171025392</td>
