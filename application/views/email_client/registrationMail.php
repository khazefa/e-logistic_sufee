                                                                                                                ...
                                                                                                                <table width="280" border="0" cellpadding="0" cellspacing="0" align="right">	
                                                                                                                        <tr>
                                                                                                                                <td height="60" valign="middle" width="100%" align="right">
                                                                                                                                    <span style="color: #333333;"><?php echo $contentHeader; ?></span>
                                                                                                                                </td>
                                                                                                                        </tr>
                                                                                                                </table>
                                                                                                                <!-- /view Online --> 
                                                                                                                ...
                                                                                                                <table width="600" border="0" cellpadding="0" cellspacing="0" align="center">
                                                                                                                        <tr>
                                                                                                                                <td align="center" valign="middle" style="font-size: 24px; color: #444444; line-height: 32px; font-weight: 500;">
                                                                                                                                    Hello <?php echo $fullName;?>, here is your account details
                                                                                                                                </td>
                                                                                                                        </tr>
                                                                                                                        <tr>
                                                                                                                                <td width="100%" height="30"></td>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                                <td align="left" valign="middle" width="100%" style="font-size: 14px; color: #808080; line-height: 22px; font-weight: 400;">
                                                                                                                                    <table width="100%">
                                                                                                                                        <tr><td width="15%">Full Name :</td><td><?php echo $fullName;?></td></tr>
                                                                                                                                        <tr><td>Username :</td><td><?php echo $userName;?></td></tr>
                                                                                                                                        <tr><td>Password :</td><td><?php echo $userPass;?></td></tr>
                                                                                                                                        <tr><td>Phone :</td><td><?php echo $userPhone;?></td></tr>
                                                                                                                                    </table>
                                                                                                                                </td>
                                                                                                                        </tr>
                                                                                                                        <tr>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                                <td width="100%">
                                                                                                                                    <span style="font-size: 12px; font-style: italic;">Please keep this email as your registration backup.</span>
                                                                                                                                </td>
                                                                                                                        </tr>
                                                                                                                </table>
                                                                                                        </td>
